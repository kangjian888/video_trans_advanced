...
#
# Generated by export_simulation on Wed Aug 01 15:48:08 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './tri_mode_ethernet_mac_1.sh' script.

./tri_mode_ethernet_mac_1.sh -reset_run
...
./tri_mode_ethernet_mac_1.sh -noclean_files

For more information on the script, please type './tri_mode_ethernet_mac_1.sh -help'.
