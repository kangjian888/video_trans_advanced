...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/video_trans_sourcecode/ip_new/managed_ip_project/managed_ip_project.runs/eth_tx_gtp_rx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_tx_gtp_rx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_tx_gtp_rx_fifo.tcl
