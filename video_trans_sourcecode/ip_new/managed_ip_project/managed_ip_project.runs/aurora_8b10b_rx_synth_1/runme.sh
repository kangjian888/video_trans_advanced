...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/video_trans_sourcecode/ip_new/managed_ip_project/managed_ip_project.runs/aurora_8b10b_rx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_8b10b_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aurora_8b10b_rx.tcl
