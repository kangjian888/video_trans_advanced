...
#LED_0 RX_HARD_ERR, LED_1 RX_CHANNEL_UP, LED_2 RX_LANE_UP, LED_3 SOFT_ERR
set_property PACKAGE_PIN M26 [get_ports RX_HARD_ERR]
set_property IOSTANDARD LVCMOS33 [get_ports RX_HARD_ERR]
set_property PACKAGE_PIN T24 [get_ports RX_CHANNEL_UP]
set_property IOSTANDARD LVCMOS33 [get_ports RX_CHANNEL_UP]
set_property PACKAGE_PIN T25 [get_ports RX_LANE_UP]
set_property IOSTANDARD LVCMOS33 [get_ports RX_LANE_UP]
set_property PACKAGE_PIN R26 [get_ports SOFT_ERR]
set_property IOSTANDARD LVCMOS33 [get_ports SOFT_ERR]
