...
module axis_dwidth_converter_0(aclk, aresetn, s_axis_tvalid, s_axis_tready, 
  ...
  m_axis_tlast)
/* synthesis syn_black_box black_box_pad_pin="aclk,aresetn,s_axis_tvalid,s_axis_tready,s_axis_tdata[7:0],s_axis_tlast,m_axis_tvalid,m_axis_tready,m_axis_tdata[15:0],m_axis_tkeep[1:0],m_axis_tlast" */;
  input aclk;
  input aresetn;
  input s_axis_tvalid;
