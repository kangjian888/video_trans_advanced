...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/eth_rx_gtp_tx/eth_rx_gtp_tx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_rx_gp_tx_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_rx_gp_tx_top.tcl -notrace
