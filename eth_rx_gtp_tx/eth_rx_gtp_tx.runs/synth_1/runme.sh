...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/eth_rx_gtp_tx/eth_rx_gtp_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_rx_gp_tx_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_rx_gp_tx_top.tcl
