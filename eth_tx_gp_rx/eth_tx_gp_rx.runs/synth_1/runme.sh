...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/eth_tx_gp_rx/eth_tx_gp_rx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_tx_gp_rx_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_tx_gp_rx_top.tcl
