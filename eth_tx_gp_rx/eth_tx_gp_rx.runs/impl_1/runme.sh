...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_advanced/eth_tx_gp_rx/eth_tx_gp_rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_tx_gp_rx_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_tx_gp_rx_top.tcl -notrace
